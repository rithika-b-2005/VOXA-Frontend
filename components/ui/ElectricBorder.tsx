...
const ElectricBorder = ({ children, color = '#C0C0C0', speed = 1, chaos = 1, thickness = 2, className, style }: ElectricBorderProps) => {
      ...
      >
        <defs>
          <filter id={filterId} colorInterpolationFilters="sRGB" x="-20%" y="-20%" width="140%" height="140%">
            ...
            <feBlend in="part1" in2="part2" mode="multiply" result="combinedNoise" />
            <feDisplacementMap
              in="SourceGraphic"
              in2="combinedNoise"
              scale={30}
